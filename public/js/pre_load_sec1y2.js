if (sessionStorage.getItem('data1__')){ 
    var inputs_formulario = document.querySelector('#form1').getElementsByTagName('input');
    var selects_formulario = document.querySelector('#form1').getElementsByTagName('select');
